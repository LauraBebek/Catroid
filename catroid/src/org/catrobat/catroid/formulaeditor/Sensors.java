...
public enum Sensors {
	...
	MOTION_ON_SPRITE, MOTION_ON_STAGE, DIRECTION_ON_SPRITE, DIRECTION_ON_STAGE, OBJECT_X(true), OBJECT_Y(true), OBJECT_TRANSPARENCY(true), OBJECT_BRIGHTNESS(true),
	OBJECT_SIZE(true), OBJECT_ROTATION(true), OBJECT_LAYER(true);
