...
public class PhiroRGBLightBrick extends FormulaBrick implements SpinnerBrick{
	private static final long serialVersionUID = 1L;

	private int spinnerSelectionID;
	private final int layoutId = R.layout.brick_phiro_rgb_light;
	private final int spinnerId = R.id.brick_phiro_rgb_light_spinner;
