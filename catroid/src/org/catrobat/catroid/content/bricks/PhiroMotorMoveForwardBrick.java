...
public class PhiroMotorMoveForwardBrick extends FormulaBrick implements SpinnerBrick {
	...
	private final int layoutId = R.layout.brick_phiro_motor_forward;
	private final int spinnerId = R.id.brick_phiro_motor_forward_action_spinner;
