...
public class FormulaEditorListFragment extends SherlockListFragment implements Dialog.OnKeyListener {
	...
	private static final int[] SENSOR_ITEMS = {R.string.formula_editor_sensor_x_acceleration,
			...
			R.string.formula_editor_sensor_motion_on_sprite, R.string.formula_editor_sensor_motion_on_stage,
			R.string.formula_editor_sensor_direction_on_sprite, R.string.formula_editor_sensor_direction_on_stage};
